  ...
  render() {
    return (
      <View
        ...
        <Text style={[GlobalStyles.buttonText, {color: headerColor}]}>|</Text>
        <Pressable
          style={[
          ...
          {this.context.value.selected === 1 && (
            <Text style={[GlobalStyles.buttonText]}> EVM</Text>
          )}
        </Pressable>
        <Text style={[GlobalStyles.buttonText, {color: headerColor}]}>|</Text>
        <Pressable
          ...
          />
          {this.context.value.selected === 2 && (
            <Text style={[GlobalStyles.buttonText]}> Polka</Text>
          )}
        </Pressable>
        <Text style={[GlobalStyles.buttonText, {color: headerColor}]}>|</Text>
        <Pressable
