          ...
          this.props.transactions.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <View>
                  ...
                  >
                    ...
                    {item.tokenSymbol !== undefined ? (
                      ...
                      >
                        {epsilonRound(
                          item.value / Math.pow(10, parseInt(item.tokenDecimal))
                        )}
                      </Text>
                    ) : (
                      <Text
                    ...
                    {"  "}
                    {item.tokenSymbol !== undefined ? item.tokenSymbol : native}
                  </Text>
                </View>
                <View style={{ marginLeft: 30 }}>
                  ...
                  >
                    GasFee {"\n"}
                    {epsilonRound(
                      (item.gas * item.gasPrice) / 1000000000000000000
                    ) > 0
                      ? epsilonRound(
                          (item.gas * item.gasPrice) / 1000000000000000000
                        )
              ...
              <View style={{ width: "100%", alignSelf: "center" }}>
                <Pressable
                  onPress={() =>
                    Linking.openURL(`${NODE_ENV_EXPLORER}tx/` + item.hash)
                  }
                >
                  <Text
                    style={{
